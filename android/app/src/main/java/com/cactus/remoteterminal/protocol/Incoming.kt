...
sealed class RelayEvent {
    ...
    data class AgentMetrics(val agentId: String, val metrics: MachineMetrics) : RelayEvent()
...
object Incoming {
    ...
    fun parse(text: String): RelayEvent {
        ...
        return when (val type = o.optString("type")) {
            ...
            "agent.metrics" -> RelayEvent.AgentMetrics(o.getString("agent"), MachineMetrics.fromJson(o.optJSONObject("metrics")))
